          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            {[
              ...
              { title: 'Integrate', links: [
                { label: 'MCP Server', href: 'https://www.npmjs.com/package/@jhinresh/mcp-server' },
                { label: 'AgentKit', href: 'https://github.com/JhiNResH/maiat-protocol/tree/master/packages/agentkit-plugin' },
                { label: 'ElizaOS', href: 'https://github.com/JhiNResH/maiat-protocol/tree/master/packages/eliza-plugin' },
              ]},
